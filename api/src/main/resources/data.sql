...
INSERT into users (username, password, email, enabled, firstname, lastname)
    values ('user','$2a$10$EUxPWS43H55VHJS6OtNdwOVtRwNprMGnwq0sXPhdwVpJo9v5oKYjO','user@gmail.com',true, 'User', 'Admin');

INSERT into users (username, password, email, enabled, firstname, lastname)
    values ('admin','$2a$10$hbxecwitQQ.dDT4JOFzQAulNySFwEpaFLw38jda6Td.Y/cOiRzDFu','admin@gmail.com',true, 'User', 'Regular');
