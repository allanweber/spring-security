...
import com.allanweber.api.registration.verification.Verification;
import com.allanweber.api.registration.verification.VerificationRepository;
...
class RegistrationControllerTest {
    ...
    public void verifyEmail() throws Exception {
        ...
        mockMvc.perform(get("/registration/verify/email?id=" + id))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse();
    }
